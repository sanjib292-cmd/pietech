...
mongoose.connect(`mongodb+srv://Sanjib292:Sanjib292@cluster0.vlkzh.mongodb.net/Cluster1?retryWrites=true&w=majority`, { useNewUrlParser: true, useUnifiedTopology: true }).then(console.info('Connected To DB'))
